...
public partial class MudThemeManager : ComponentBaseWithState
{
    ...
    [Parameter]
    public IEnumerable<IThemePreset>? ThemePresets { get; set; }
    ...
    private bool _forceColorRender;
    private IThemePreset? _selectedPreset;
    ...
    private string _noPresets = "No Presets";
    ...
    protected override void OnAfterRender(bool firstRender)
    {
        ...
        if (_forceColorRender)
        {
            _forceColorRender = false;
        }
    }
    ...
    private Task OnDefaultElevationAsync(int value)
    {
        ...
        var newElevation = newDefaultElevation.Elevation[value];
    ...
    private Task OnThemePresetChangedAsync(IThemePreset? obj)
    {
        ...
        Theme.Theme = _selectedPreset.Theme;

        _customTheme = _selectedPreset.Theme.DeepClone();
        _currentPaletteLight = _selectedPreset.Theme.PaletteLight.DeepClone();
        _currentPaletteDark = _selectedPreset.Theme.PaletteDark.DeepClone();
